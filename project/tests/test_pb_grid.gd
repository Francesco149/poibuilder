...
func test_unbind_conflicting_stock_shortcuts():
	...
	assert_eq(settings.get_shortcut("poibuilder/grid_raise").get_name(), "Grid: Raise Elevation")
	assert_eq(settings.get_shortcut("poibuilder/grid_lower").get_name(), "Grid: Lower Elevation")
	assert_true(settings.get_shortcut("poibuilder/grid_raise").has_meta("original"))
	assert_true(settings.get_shortcut("poibuilder/grid_lower").has_meta("original"))
