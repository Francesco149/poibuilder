...
func _ready() -> void:
	...
	print("")
	print("Merge faces (v0.8.0: overlay OPERATIONS, Merge button):")
	print(" 31. Subdiv a face, select all 4 sub-quads (rubber band), Merge: the")
	print("     four become ONE planar face (an octagon outline — the rim midpoints")
	print("     stay as collinear corners; T-junctions against neighbors are")
	print("     expected). Undo restores the 4 quads.")
	print(" 32. Merge on non-coplanar or non-adjacent selections does nothing and")
	print("     logs a warning to the console.")
	print("")
	print("Weld vertices (v0.8.0: overlay OPERATIONS, Vertices row):")
	print(" 33. VERTEX mode: select 2 corners (shift-click), Weld: both collapse to")
	print("     their midpoint and drag as one afterwards; undo separates them again.")
	print(" 34. Weld with fewer than 2 vertices selected does nothing (button")
	print("     disabled) and the overlay SELECTION counts stay consistent.")
	print("=============================================================================")
